      ...
      <div className="container mx-auto max-w-3xl px-4 animate-fade-in-blur py-16">
        <div className="relative inline-block">
          ...
          <div className="relative group">
            ...
            <div className="absolute -top-8 left-full ml-3 opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none z-50 md:left-full md:ml-3 sm:-left-64 sm:ml-0">
              <div className="bg-background border border-border rounded-lg shadow-lg p-3 min-w-[250px] max-w-[80vw] md:max-w-none">
                <div className="flex flex-col items-start gap-2">
                  ...
                  <p>
                    Yesterday worked <b>2h 25m</b>
                  </p>
                </div>
              </div>
              <div className="absolute top-4 -left-1 w-2 h-2 bg-background border-l border-b border-border rotate-45 md:-left-1 sm:left-[248px]"></div>
            </div>
          </div>
        </div>
        <div className="mt-8 flex flex-col gap-2">
          <h1 className="text-4xl font-bold text-transparent bg-gradient-to-b from-gray-600 via-gray-700 to-primary dark:from-gray-300 dark:via-gray-200 dark:to-primary bg-clip-text">
            Hi, I'm Venketesh —{" "}
          ...
          <div className="mt-4 flex flex-wrap items-center gap-x-1.5 gap-y-2 text-base md:text-lg text-neutral-500 whitespace-pre-wrap">
            ...
            >
              ...
              <p className="ml-1 text-sm font-bold">React Native</p>
            </Link>
            <span className="whitespace-pre-wrap">, </span>
            <Link
              target="_blank"
            ...
            <b className="whitespace-pre-wrap text-primary">UI</b>
            <span className="whitespace-pre-wrap">
              {" "}
              design. Enthusiastic about{" "}
            </span>
            <b className="whitespace-pre-wrap text-primary">React Native</b>
            <span className="whitespace-pre-wrap">
        ...
        <div className="mt-8 flex gap-4">
          <Link className="hover:cursor-pointer" href="/resume">
            <button
              data-slot="button"
              className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg:not([class*='size-'])]:size-4 shrink-0 [&amp;_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive border bg-background btn-inner-shadow hover:bg-accent hover:text-accent-foreground dark:bg-input/30 dark:border-input dark:hover:bg-input/50 h-9 px-4 py-2 has-[&gt;svg]:px-3 inset-shadow-indigo-500"
            >
              <svg
          ...
          <Link className="hover:cursor-pointer" href="/contact">
            <button
              data-slot="button"
              className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg:not([class*='size-'])]:size-4 shrink-0 [&amp;_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive bg-primary text-primary-foreground btn-inner-shadow hover:bg-primary/90 hover:cursor-pointer h-9 px-4 py-2 has-[&gt;svg]:px-3 inset-shadow-indigo-500"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
