    ...
    <>
      <div className="mt-8 flex flex-col gap-2">
        <Image
          ...
          width={100}
          height={100}
          className="rounded-full border border-gray-200 bg-blue-300 transition-all duration-300 ease-in-out hover:scale-90 dark:bg-yellow-300"
        />
        ...
        <div className="mt-4 flex flex-wrap items-center gap-x-1.5 gap-y-2 text-base md:text-xl text-neutral-500 whitespace-pre-wrap">
          ...
          <b className="whitespace-pre-wrap">Three.js</b>
          <span className="whitespace-pre-wrap">
